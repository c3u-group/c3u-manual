...
<div class="a4-form">
  ...
  <table class="check-table" id="apply-table" data-mat-extra="1">
    <tr>
      ...
      <td class="label" style="padding:0;" width=19%>名称</td>
      <td class="label" style="padding:0;">规格</td>
      <td class="label" style="padding:0;" width=7%>数量</td>
      <td class="label" style="padding:0;" width=9%>级别</td>
      <td class="label" style="padding:0;" width=12%>预计<br/>价格</td>
      <td class="label" style="padding:0;" width=14%>购买<br/>渠道</td>
    </tr>
    <tr class="material-row">
      <td style="padding:0;"><textarea rows="1" class="fill-input-cell"></textarea></td>
      <td style="padding:0;"><textarea rows="1" class="fill-input-cell"></textarea></td>
      <td style="padding:0;"><textarea rows="1" class="fill-input-cell"></textarea></td>
      <td style="padding:0;"><textarea rows="1" class="fill-input-cell"></textarea></td>
      <td style="padding:0;"><textarea rows="1" class="fill-input-cell"></textarea></td>
  ...
  <div class="note">
    注：1. 集中采购指通过学校指定平台、课题组指定厂商购买，支付方式为对公转账，每月集中采购 2 次，分别为 1 日、16日（遇法定节假日，顺延至假期后第 1个工作日）提交。<br>
